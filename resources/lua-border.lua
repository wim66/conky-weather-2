...
function draw_box(cr,t)
    ...
    if border_COLOR == "default" then color_x = { {1,0x34495E,0.75} } end
    if border_COLOR == "green" then color_x = { {0.25,0x003E00,0.75}, {0.5,0x03F404,1}, {0.75,0x003E00,0.75} } end
    if border_COLOR == "blue" then color_x =  { {0.25,0x0032FF,0.75}, {0.5,0x00CCFF,1}, {0.75,0x0032FF,0.75} } end
    if border_COLOR == "orange" then color_x =  { {0.25,0xE05700,0.75}, {0.5,0xFFD145,1}, {0.75,0xE05700,0.75} } end
    if border_COLOR == "black" then color_x =  { {0.25,0x101010,0.75}, {0.5,0xA1A1A1,1}, {0.75,0x101010,0.75} } end
